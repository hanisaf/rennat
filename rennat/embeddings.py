...
class HuggingFaceHubEmbeddings(langchain.embeddings.HuggingFaceHubEmbeddings):
    def __init__(self, repo_id: str = "sentence-transformers/multi-qa-distilbert-dot-v1", **kwargs):
        super().__init__(repo_id = repo_id, huggingfacehub_api_token=os.getenv("HUGGINGFACEHUB_API_TOKEN"), **kwargs)
